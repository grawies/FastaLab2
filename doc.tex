...
\image{fourpoint}{The setup of the four-point measurement used in this laboratory. Two separate electrical circuit loops ensure contact voltage drops are taken into account in the measurement. Image taken from the lab instruction.}
